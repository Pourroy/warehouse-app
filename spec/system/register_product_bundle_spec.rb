...
describe 'Usuário registra um kit' do
  ...
  it 'com sucesso' do
    ...
    ProductModel.create!(name: 'Caneca BOSON DE HIGS', height: '12', width: '9', length: '9',
                         weight: 350, sku: 'SKj349asdj3@#$', supplier: s, category: c)
    ProductModel.create!(name: 'Garrafa Térmica LHC', height: '20', width: '15', length: '15',
                         weight: 500, sku: 'SKj349asdj3@#1', supplier: s, category: c)
